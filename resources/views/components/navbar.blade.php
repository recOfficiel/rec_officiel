        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a href="{{ routet('login')}}" class="nav-link me-3 wow fadeInDown fs-6 animate__animated animate__pulse animate__bounce" onmouseover="this.style.color='#3C3882'; this.classList.add('animate__headShake')" data-wow-delay="0.1s" onmouseout="this.style.color=''; this.classList.remove('animate__headShake')" style="margin-top: -8px;"><button class="btn btn-primary" style="background-color: #293070;"><i class="fas fa-user-circle fa-lg"></i> Se connecter</button></a>
